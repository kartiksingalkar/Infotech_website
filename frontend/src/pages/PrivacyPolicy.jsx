    ...
    return (
        <>
            ...
            <div className='pp-content'>
                <p>Ellora Infotech is a global leader in offering professional lead generation, and appointment setting services. This privacy policy page explains how we handle personal information so you are sure about our compliance with Privacy Act. Ellora Infotech (“we,” “our,” or “us”) is committed to protecting your privacy.</p>
                <p>
                    This Privacy Policy explains how your personal information is collected, used, and disclosed by Ellora Infotech.
                </p>
                <p>
                    This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”) alongside our application, www.ellorainfotech.com. By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service.
                </p>

                <p className='pp-title'>Definitions and key terms</p>
                ...
                <p>
                    ...
                    <ul>
                        ...
                        <li>
                            Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Ellora Infotech that is responsible for your information under this Privacy Policy.
                        </li>
                        <li>Country: where www.ellorainfotech.com or the owners/founders of www.ellorainfotech.com are based, in this case is India</li>
                        <li>Customer: refers to the company, organization or person that signs up to use the www.ellorainfotech.com Service to manage the relationships with your consumers or service users.</li>
                        <li>Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit www.ellorainfotech.com and use the services.</li>
                        ...
                        <ul><li>Personnel: refers to those individuals who are employed by Ellora Infotech or are under contract to perform a service on behalf of one of the parties.</li></ul>
                        ...
                        <li>Service: refers to the service provided by www.ellorainfotech.com as described in the relative terms (if available) and on this platform.</li>
                        ...
                        <li>Website: Ellora Infotech’s site, which can be accessed via this URL: www.ellorainfotech.com</li>
                        <li>You: a person or entity that is registered with www.ellorainfotech.com to use the Services.</li>
                    </ul>
                </p>

                <p className='pp-title'>What Information Do We Collect?</p>
                ...
                <p><ul>
                    <li>Voluntarily provided information, which you share with us during sign up, contact us or request a quote form also information like below :</li>
                    <li>Voluntarily provided information, which you share with us during sign up, contact us or request a quote form also information like below :</li>
                    <li>Information is automatically collected using cookies during browsing the website. This website also uses third-party tracking technologies and server logs to gather information like your IP address, location, browsing history, etc.</li>
                </ul></p>
                <p className='pp-title'>
                    When do we use end-user information from third parties?
                </p>
                <p>The website will collect End User Data necessary to provide the Ellora Infotech services to our customers. End users may voluntarily provide us with the information they have made available on social media websites. If you provide us with any such information, we may collect publicly available information from the social media websites you have indicated.<br />
                ...
                <p className='pp-title'>When do we use customer information from third parties?</p>
                <p>We receive some information from the third parties when you contact us.</p>
                <p>For example, when you submit your email address to us to show interest in becoming a Ellora Infotech customer, we receive information from a third party that provides automated fraud detection services to www.ellorainfotech.com.</p>
                ...
                <p className='pp-title'>Do we share the information we collect with third parties?</p>
                ...
                <p className='pp-title'>Where and when is information collected from customers and end users?</p>
                <p>The website will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>

                <p className='pp-title'>How Do We Use The Information We Collect?</p>
                ...
                <p className='pp-title'>How Do We Use Your Email Address?</p>
                ...
                <p className='pp-title'>How Long Do We Keep Your Information?</p>
                <p>We keep your information only so long as we need it to provide services to you and fulfill the purposes described in this policy. This is also the case for anyone that we share your information with and who carries out services on our behalf. When we no longer need to use your information and there is no need for us to keep it to comply with our legal or regulatory obligations, we’ll either remove it from our systems or depersonalize it so that we can’t identify you.</p>

                <p className='pp-title'>How Do We Protect Your Information?</p>
                <p>We implement a variety of security measures to maintain the safety of your personal information when you place an order or enter, submit, or access your personal information. We offer the use of a secure server. All supplied sensitive information is transmitted via Secure Socket Layer (SSL) technology and then encrypted into our database only to be accessible by those authorized with special access rights to such systems, and are required to keep the information confidential. We cannot, however, ensure or warrant the absolute security of any information you transmit to www.ellorainfotech.com or guarantee that your information on the Service may not be accessed, disclosed, altered, or destroyed by a breach of any of our physical, technical, or managerial safeguards.</p>

                <p className='pp-title'>Could my information be transferred to other countries?</p>
                <p>Ellora Infotech is incorporated in India. Information collected via our website, through direct interactions with you, or from use of our help services may be transferred from time to time to our offices or personnel, or to third parties, located throughout the world, and may be viewed and hosted anywhere in the world, including countries that may not have laws of general applicability regulating the use and transfer of such data. To the fullest extent allowed by applicable law, by using any of the above, you voluntarily consent to the trans-border transfer and hosting of such information.</p>

                <p className='pp-title'>Is the information collected through the website is secure?</p>
                <p>We take precautions to protect the security of your information. We have physical, electronic, and managerial procedures to help safeguard, prevent unauthorized access, maintain data security, and correctly use your information. However, neither people nor security systems are fool proof, including encryption systems. In addition, people can commit intentional crimes, make mistakes or fail to follow policies. Therefore, while we use reasonable efforts to protect your personal information, we cannot guarantee its absolute security. If applicable law imposes any non-disclaimable duty to protect your personal information, you agree that intentional misconduct will be the standard used to measure our compliance with that duty.</p>

                <p className='pp-title'>Can I update or correct my information?</p>
                <p>The rights you have to request updates or corrections to the information website collects depend on your relationship with website. Personnel may update or correct their information as detailed in our internal company employment policies.</p>
                <p>Customers have the right to request the restriction of certain uses and disclosures of personally identifiable information as follows.</p>
                <p>You can contact us in order to<br />
                    (1) Update or correct your personally identifiable information,<br />
                    (2) Change your preferences with respect to communications and other information you receive from us, or<br />
                ...
                <p className='pp-title'>Personnel</p>
                <p>If you are a Ellora Infotech worker or applicant, we collect information you voluntarily provide to us. We use the information collected for Human Resources purposes in order to administer benefits to workers and screen applicants. You may contact us in order to <br />
                    (1) update or correct your information,<br />
                    (2) change your preferences with respect to communications and other information you receive from us.<br />
                    (3) receive a record of the information we have relating to you. Such updates, corrections, changes and deletions will have no effect on other information that we maintain, or information that we have provided to third parties in accordance with this Privacy Policy prior to such update, correction, change or deletion.</p>

                <p className='pp-title'>Sale of Business</p>
                <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of Ellora Infotech or any of its Corporate Affiliates (as defined herein), or that portion of Ellora Infotech or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy</p>

                <p className='pp-title'>Affiliates</p>
                <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, “Corporate Affiliate” means any person or entity which directly or indirectly controls, is controlled by or is under common control with Ellora Infotech, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p>

                <p className='pp-title'>Governing Law</p>
                ...
                <p>By using www.ellorainfotech.com or contacting us directly, you signify your acceptance of this Privacy Policy. If you do not agree to this Privacy Policy, you should not engage with our website, or use our services. Continued use of the website, direct engagement with us, or following the posting of changes to this Privacy Policy that do not significantly affect the use or disclosure of your personal information will mean that you accept those changes.</p>

                <p className='pp-title'>Your Consent</p>
                <p>We’ve updated our Privacy Policy to provide you with complete transparency into what is being set when you visit our site and how it’s being used. By using our Ellora Infotech, registering an account, or making a purchase, you hereby consent to our Privacy Policy and agree to its terms.</p>

                <p className='pp-title'>Links to Other Websites</p>
                <p>This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated or controlled by Ellora Infotech. We are not responsible for the content, accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us.</p>
                <p>Please remember that when you use a link to go from the Services to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform, is subject to that website’s own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.</p>

                <p className='pp-title'>Advertising</p>
                <p>This website may contain third party advertisements and links to third party sites. Ellora Infotech does not make any representation as to the accuracy or suitability of any of the information contained in those advertisements or sites and does not accept any responsibility or liability for the conduct or content of those advertisements and sites and the offerings made by the third parties.</p>
                <p>Advertising keeps www.ellorainfotech.com and many of the websites and services you use free of charge. We work hard to make sure that ads are safe, unobtrusive, and as relevant as possible.</p>
                <p>Third party advertisements and links to other sites where goods or services are advertised are not endorsements or recommendations by www.ellorainfotech.com of the third party sites, goods or services. Ellora Infotech takes no responsibility for the content of any of the ads, promises made, or the quality/reliability of the products or services offered in all advertisements.</p>

                <p className='pp-title'>Cookies for Advertising</p>
                ...
                <p className='pp-title'>Cookies</p>
                ...
                <p className='pp-title'>Blocking and disabling cookies and similar technologies</p>
                ...
                <p className='pp-title'>Remarketing Services</p>
                ...
                <p className='pp-title'>Kids’ Privacy</p>
                ...
                <p className='pp-title'>Changes To Our Privacy Policy</p>
                ...
                <p className='pp-title'>Third-Party Services</p>
                ...
                <p className='pp-title'>Tracking Technologies</p>
                <p className='pp-title'>Google Maps API</p>
                <p>Google Maps API is a robust tool that can be used to create a custom map, a searchable map, check-in functions, display live data synching with location, plan routes, or create a mashup just to name a few. Google Maps API may collect information from You and from Your Device for security purposes. Google Maps API collects information that is held in accordance with its Privacy Policy.</p>
                <p className='pp-title'>Cookies</p>
                ...
                <p className='pp-title'>Local Storage</p>
                ...
                <p className='pp-title'>Sessions</p>
                ...
                <p className='pp-title'>Information about General Data Protection Regulation (GDPR)</p>
